...
(function($) {
  ...
  function TagsInput(element, options) {
    ...
    if(this.placeholderText === '' && this.$element.data('placeholder')){
      this.placeholderText = this.$element.data('placeholder');
    }
  ...
  TagsInput.prototype = {
    ...
    build: function(options) {
      ...
      self.$container.on('paste input propertychange', 'input', $.proxy(function(event) {
        var $input = $(event.target);
